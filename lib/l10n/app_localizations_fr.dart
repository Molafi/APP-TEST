...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get georesearchTitle => 'GéoRecherche';

  @override
  String get navGeoResearch => 'Sol';
  ...
  String get georesearchEstimateNotice =>
      'Ce sont des estimations basées sur votre localisation et votre photo. Les valeurs exactes de sodium, de salinité et de nutriments nécessitent une analyse de sol en laboratoire.';
  ...
  String get georesearchAerialNotice =>
      'Les images aériennes ne sont qu\'un contexte non daté et ne constituent pas un levé aérien actuel.';
  ...
  String get georesearchTopoNotice =>
      'Estimation documentaire. Des courbes de niveau exploitables en conception exigent un levé topographique agréé (instruments ou drone).';
  ...
  String get georesearchGwNotice =>
      'Estimation régionale. Une étude hydrogéologique et un permis de forage sont requis avant tout forage.';
  ...
  String get georesearchBuildNotice =>
      'Évaluation préliminaire uniquement. Ceci n\'est PAS un rapport géotechnique et ne doit pas servir au dimensionnement des fondations. Faites réaliser une étude géotechnique agréée avant de construire.';
